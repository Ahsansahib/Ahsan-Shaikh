import os, requests, re, time, sys,uuid
...
def main_apv():
    ...
    try:
        key1=open('/data/data/com.termux/files/usr/bin/.xd-cov', 'r').read()
        print(key1)
    except IOError:
        os.system("clear")
        logo()
        ...
        print ("[*]--------------------------------------------------------------")
        kok=open('/data/data/com.termux/files/usr/bin/.ali-cov', 'w')
        kok.write(myid)
        kok.close()
        print ("")
        print ("")
        ...
        exit()
    r1=requests.get("https://raw.githubusercontent.com/Ahsansahib/Ahsan-Shaikh/main/Aproval.txt").text
    if key1 in r1:
        pass
    else:
        os.system("clear")
